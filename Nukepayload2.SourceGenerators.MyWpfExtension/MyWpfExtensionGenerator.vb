...
Public Class MyWpfExtensionGenerator
    ...
    Public Sub Execute(context As GeneratorExecutionContext) Implements ISourceGenerator.Execute
        ...
        ' Commit code
        context.AddSource("MyWpfExtension",
    ...
    ''' <returns></returns>
    Private Shared Function GetWpfWindowClasses(receiver As AllClassesSyntaxReceiver,
                                                compilation As Compilation,
                                                windowTypeSymbol As INamedTypeSymbol) As IEnumerable(Of INamedTypeSymbol)
        Return From cls In receiver.AllClasses
               Let classSyntaxTree = cls.SyntaxTree,
                   model = compilation.GetSemanticModel(classSyntaxTree),
                   clsSymbol = TryCast(model.GetDeclaredSymbol(cls), INamedTypeSymbol)
